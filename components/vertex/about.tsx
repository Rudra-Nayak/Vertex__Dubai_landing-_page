      ...
      <div className="grid min-h-[85svh] grid-cols-1 lg:grid-cols-2">
        <Reveal className="relative min-h-[520px] overflow-hidden lg:min-h-full">
          <motion.img
            ...
            className="absolute -inset-y-[10%] left-0 h-[120%] w-full object-cover"
            style={{ y: imageY }}
          />
        ...
        <div className="flex items-center px-6 py-20 md:px-12 md:py-28 lg:px-20">
          <Reveal className="max-w-xl">
            <p className="mb-6 flex items-center gap-4 font-sans text-[11px] uppercase tracking-[0.4em] text-gold">
            ...
            <p className="font-sans text-base leading-8 text-muted-foreground md:text-lg">
            ...
            <svg
              className="mt-14 h-24 w-72 text-gold"
              viewBox="0 0 360 120"
              fill="none"
